...
Region.prototype.fetch = function (callback) {
    ...
    requestCallback = function (data) {
        console.log('Region.fetch.requestCallback');
...
Region.prototype._fetchPage = function (callback) {
    ...
    console.log('Region._fetchPage: ' + this.pageNo);
...
Region.prototype._addPage = function (page) {
    ...
    console.log('Region._addPage added ' + page.List.length + ' listings for a total of ' + this.listings.length);
};
...
Region.prototype._isLastPage = function (page) {
    ...
    console.log('Region._isLastPage: ' + estimatedRowsFetched + ' vs ' + totalRows);
